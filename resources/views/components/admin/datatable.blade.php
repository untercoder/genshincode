...
@if($modelName === "News")<a href="{{route("news.create")}}" type="button" class="btn btn-primary mt-3 mb-1">Создать новость</a>@endif
<hr>
            ...
            @endif
               <td>
                   <div class="btn-group" role="group" aria-label="Basic outlined example">
                        ...
                        @if($modelName === "News")<a href="{{route('news.edit', $element)}}" type="button" class="btn btn-warning">Редактировать</a>@endif
                        </form>
                   </div>
               </td>
        </tr>
